...
This repo references Syncfusion Essential JS 2 components which are licensed separately. See `license` file for details.

For Syncfusion licensing and community options, visit: https://www.syncfusion.com/support/licensing
